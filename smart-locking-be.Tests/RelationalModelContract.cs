...
internal static class RelationalModelContract
{
    ...
    [
        ...
        I("RefreshToken", "UX_RefreshToken_TokenHash", true, null, "TokenHash"),
        I("RefreshToken", "IX_RefreshToken_UserId_ExpiresAt", false, null, "UserId", "ExpiresAt"),
        I("Locker", "UX_Locker_Code", true, null, "Code"),
        ...
        I("LockerCompartment", "UX_LockerCompartment_LockerId_HardwareCode", true, null, "LockerId", "HardwareCode"),
        I("LockerCompartment", "UX_LockerCompartment_LockerId_HardwareChannel", true, null, "LockerId", "HardwareChannel"),
        ...
        I("DeliveryRequest", "IX_DeliveryRequest_SessionExpiresAt_Status", false, null, "SessionExpiresAt", "Status"),
        I("DeliveryRequest", "IX_DeliveryRequest_Locker_Status", false, null, "LockerId", "Status"),
        I("DeviceInstallation", "UX_DeviceInstallation_InstallationId", true, null, "InstallationId"),
        I("DeviceInstallation", "UX_DeviceInstallation_ExpoPushToken", true, null, "ExpoPushToken"),
        I("DeviceInstallation", "IX_DeviceInstallation_UserId_IsActive", false, null, "UserId", "IsActive"),
        I("ReturnRequest", "UX_ReturnRequest_ReturnCode", true, null, "ReturnCode"),
        I("ReturnRequest", "IX_ReturnRequest_Resident_Status", false, null, "ResidentProfileId", "Status"),
        I("ReturnRequest", "IX_ReturnRequest_Locker_Status", false, null, "LockerId", "Status"),
        I("CompartmentReservation", "UX_CompartmentReservation_Active", true, "\"ReleasedAt\" IS NULL", "LockerCompartmentId"),
        I("CompartmentReservation", "IX_CompartmentReservation_DeliveryRequestId", false, null, "DeliveryRequestId"),
        I("CompartmentReservation", "IX_CompartmentReservation_ReturnRequestId", false, null, "ReturnRequestId"),
        ...
        I("LockerAccessEvent", "IX_LockerAccessEvent_Locker_OccurredAt", false, null, "LockerId", "OccurredAt"),
        I("LockerAccessEvent", "IX_LockerAccessEvent_Compartment_OccurredAt", false, null, "LockerCompartmentId", "OccurredAt"),
        I("LockerAccessEvent", "IX_LockerAccessEvent_User_OccurredAt", false, null, "UserId", "OccurredAt"),
        I("LockerAccessEvent", "IX_LockerAccessEvent_DeliveryRequestId", false, null, "DeliveryRequestId"),
        I("LockerAccessEvent", "IX_LockerAccessEvent_ParcelId", false, null, "ParcelId"),
        I("LockerAccessEvent", "IX_LockerAccessEvent_ReturnRequestId", false, null, "ReturnRequestId"),
        I("OverdueCharge", "UX_OverdueCharge_ParcelId", true, null, "ParcelId"),
        I("OverdueCharge", "IX_OverdueCharge_Status", false, null, "Status"),
        I("PaymentTransaction", "UX_PaymentTransaction_ExternalOrderCode", true, "\"ExternalOrderCode\" IS NOT NULL", "ExternalOrderCode"),
        I("PaymentTransaction", "UX_PaymentTransaction_ExternalTransactionId", true, "\"ExternalTransactionId\" IS NOT NULL", "ExternalTransactionId"),
    ...
    [
        ...
        F("DeliveryRequest", "ResidentProfile", "ResidentProfileId"), F("DeliveryRequest", "Locker", "LockerId"),
        F("DeliveryRequest", "SystemPolicy", "SystemPolicyId"), F("DeliveryRequest", "LockerCompartment", "AllocatedCompartmentId"),
        F("DeviceInstallation", "User", "UserId"),
        F("ReturnRequest", "ResidentProfile", "ResidentProfileId"), F("ReturnRequest", "Parcel", "OriginalParcelId"),
        F("ReturnRequest", "Locker", "LockerId"), F("ReturnRequest", "LockerCompartment", "AllocatedCompartmentId"),
        F("CompartmentReservation", "LockerCompartment", "LockerCompartmentId"), F("CompartmentReservation", "DeliveryRequest", "DeliveryRequestId"),
        F("CompartmentReservation", "ReturnRequest", "ReturnRequestId"),
        ...
        F("LockerAccessEvent", "Locker", "LockerId"), F("LockerAccessEvent", "LockerCompartment", "LockerCompartmentId"),
        F("LockerAccessEvent", "User", "UserId"), F("LockerAccessEvent", "DeliveryRequest", "DeliveryRequestId"),
        F("LockerAccessEvent", "Parcel", "ParcelId"), F("LockerAccessEvent", "ReturnRequest", "ReturnRequestId"),
        F("OverdueCharge", "Parcel", "ParcelId", true), F("PaymentTransaction", "OverdueCharge", "OverdueChargeId"),
        F("Notification", "User", "UserId"), F("Notification", "DeliveryRequest", "DeliveryRequestId"),
        F("Notification", "Parcel", "ParcelId"),
    ...
    internal static readonly IReadOnlyDictionary<string, string[]> CheckConstraints =
        new Dictionary<string, string[]>
        {
            ...
            ["ResidentBiometric"] = ["CK_ResidentBiometric_RevokedAt"],
            ["OtpChallenge"] = ["CK_OtpChallenge_AttemptCount"],
            ["RefreshToken"] = ["CK_RefreshToken_ExpirationAndRevocation"],
            ...
            ["ReturnRequest"] = ["CK_ReturnRequest_CompartmentReleasedAt", "CK_ReturnRequest_ReservationExpiresAt", "CK_ReturnRequest_ResidentDepositedAt", "CK_ReturnRequest_ShipperPickedUpAt"],
            ["CompartmentReservation"] = ["CK_CompartmentReservation_ExactlyOneOwner", "CK_CompartmentReservation_ExpiresAfterReserved", "CK_CompartmentReservation_ReleasedAfterReserved"],
